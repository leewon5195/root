...
public class object_equals {
	...
	public static void main(String[] args) {
		...
		System.out.println("str4 vs str5.equals(): "+(str4.equals(str5))); //인스턴스의 값을 비교(String 객체)
		
		//hashcode값출력: 오버라이딩 된 객체의 식별값
		System.out.println(str4.hashCode());
		System.out.println(str5.hashCode());
		
		//identityHashCode(Object odj): 오버라이딩 되지 않는 객체의 주소값
