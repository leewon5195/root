...
public class day07_20231031 {
	...
	public static void main(String[] args) {
		...
		//배열의 크기를 출력하자.
		System.out.println("배열의크기="+arr.length+"입니다");
		...
		for(int i=0;i<card.length;i++) {
			...
			//대문자 : 65크거나 같다~90작거나 같다 소문자 : 97크거나 같다~122작거나 같다
	...
	System.out.println("정렬 전 배열:"+Arrays.toString(arrs2));
	...
	int[] card04 = new int[card01.length-2]; //크기를 공간만큼을 만들어준다(=선언)
	...
	//2차원 배열의 기본적인 고정적인 열의크기를 만드는 방법
