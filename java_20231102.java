...
//실해용 클래스 : main 메서드를 포함한 클래스 파일을 생성하면 만들어진다.
...
public class java_20231102 {
	...
	public static void main(String[] args) {
		...
		tv2 = tv1; //x200 --> x100(tv1과 같은 주소의 메모리를 참조한다.)
		//채널의 값을 출력해보자
		System.out.println("t1 현재 볼륨은"+tv1.channel+"입니다");
		System.out.println("t2 현재 볼륨은"+tv2.channel+"입니다");
		...
		//카드2에 대한 객체값 출력
		System.out.println("ca1은"+ca2.kind+","+ca2.number+"이며"+ca2.width+","+ca2.height);
		ca1.width = 50;
		ca1.height = 80;
		//카드1에 대한 객체값 출력
		System.out.println("ca1은"+ca1.kind+","+ca1.number+"이며"+ca1.width+","+ca1.height);
...
class jogger{
	...
	//객체를 생성해서 사용할수 있는 메서드 : 멤버함수, 멤버메소드--> heap영역
	void sayName() {
